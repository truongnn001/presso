"""
Batch PDF to Markdown Converter - Entry Point
Chạy tuần tự, chậm nhưng chắc chắn, xử lý lỗi tốt
"""
...
Ví dụ sử dụng:
  ...
  python main.py ./pdf_folder --no-recursive
  
  # Dừng khi gặp lỗi
  python main.py ./pdf_folder --stop-on-error
        """
    )
